...
const url = new String("www.microsoft.com"); // here String is an object with (key, value) pair

// console.log(url[0]); 
// console.log(url.__proto__); // output: object i.e {}
...
// console.log(url.slice(3, 7));
// console.log(url.slice(-14, 6));
...
// console.log(name.trim()); // removes white-spaces at begining and ending
